...
const USER_CONFIG = {
    ...
    USERS: [
      {
        ...
        openUrl: 'https://github.com/KoiSakana',
    ...
    //   {
    //     type: '*生日', name: '赵小妞宝宝', year: '2000', date: '08-19', isShowAge: true,
    //   },
      // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
      {
        type: '生日', name: '赵小妞', year: '2000', date: '09-16', isShowAge: true,
      },
      {
    ...
    CUSTOMIZED_DATE_LIST: [
      // 在一起的日子
      { keyword: 'love_day', date: '2015-05-29' },
      // 结婚纪念日
    //   { keyword: 'marry_day', date: '2022-09-09' },
      // 狗狗到家纪念日
      { keyword: 'dog_home_day', date: '2023-03-18' },
      // 你可以不断按格式往下增加
      // ...
    ],
